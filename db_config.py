...
DATABASE_URL = (
    "postgresql+psycopg2://order_user:WacekeMwangi@123@localhost:5432/order_management_db"
)
...
# @ becomes %40
DATABASE_URL = (
    "postgresql+psycopg2://order_user:WacekeMwangi%40123@localhost:5432/order_management_db"
)
